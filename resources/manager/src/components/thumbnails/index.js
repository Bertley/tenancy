...
const General16 = ({ isFavourite, isNew, image, name, price, oldPrice, slug }) => {
  ...
  return (
    <div className="card overflow-hidden">
      ...
      <div className="card-body">
        ...
        <div>
          <Link className="text-blue font-size-18" to={`/products/${slug}`}>
            {name}
          </Link>
        </div>
      </div>
...
export default withRouter(General16)
